...
async def on_message(message):
     ...
     if 'bulge' in message.content:
           print('We got one')
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
           ...
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
     elif 'cummies' in message.content:
           print('We got one')
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
     elif 'nuzzles' in message.content:
           print('We got one')
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
     elif 'cummies' in message.content:
           ...
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
     elif 'furry' in message.content:
           print('We got one')
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
     elif 'furries' in message.content:
           print('We got one')
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
     elif 'Bulge' in message.content:
           print('We got one')
           await bot.send_message(message.channel, "OwO What's this?")
           await bot.send_message(message.channel, 'https://cdn.drawception.com/images/panels/2018/4-18/43yAKNxbpW-2.png')
     elif 'Penis' in message.content:
